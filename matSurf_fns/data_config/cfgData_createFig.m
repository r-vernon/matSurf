...
histXLimPan = uipanel(h.confDataFig,'Tag','histXLimPan','Title',...
    'Histogram','Units','pixels','Position',[925,15,100,160]);
...
h.xLt_txt = uicontrol(h.thrRngPan,'String','? if x <',...
    'Tag','xLt_txt','Position',[10 45 55 15],'Enable','off');
h.xGt_txt = uicontrol(h.thrRngPan,'String','? if x >',...
    'Tag','xGt_txt','Position',[155 45 55 15],'Enable','off');
h.xBt1_txt = uicontrol(h.thrRngPan,'String','? if',...
    'Tag','xBt1_txt','Position',[35 15 30 15],'Enable','off');
h.xBt2_txt = uicontrol(h.thrRngPan,'String',' < x < ',...
    'Tag','xBt2_txt','Position',[145 15 65 15],'Enable','off');
...
thrXLimPan = uipanel(h.confDataFig,'Tag','thrAxLimPan','Title',...
    'Thr. Graph','Units','pixels','Position',[925,250,100,110]);
...
clickObj = [h.pCmAx; clickObj; h.meanEdit; h.nMinEdit; h.nMaxEdit;...
     h.othEdit; h.sdEdit; h.pMaxEdit; h.pMinEdit];
